    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          {/* Verification badges */}
          {service.erc8004Verified && (
            <span className="text-xs px-1.5 py-0.5 bg-purple-500/20 text-purple-400 rounded border border-purple-500/30" title="ERC-8004 Verified Agent">
              8004
            </span>
          )}
          {service.twitterVerified && (
            <span className="text-blue-400" title="Twitter Verified">
    ...
    async function fetchServices() {
      ...
      try {
        ...
        setServices(rawServices.map((s: Record<string, unknown>) => ({
          ...
          twitterVerified: Boolean(s.twitterVerified),
          erc8004Verified: Boolean(s.erc8004Verified),
        })));
      } catch {
